    ...
    def act(self, messages: List[Dict[str, Any]]) -> str:
        ...
        try:
            response = requests.post(self.url, files=messages[0], data=messages[1], timeout=480,
                                     proxies={"https": "socks5h://127.0.0.1:8889"})
...
if __name__ == "__main__":
    agent = Qwen2VLAgent("http://172.18.192.104:10010/v1/chat/completions")
    path_to_image = "/raid/xuyifan/Android-United-open/logs/evaluation/qwenvl-test/contacts_1_2024-09-27_04-43-49/Screen/screenshot-0-1727426679.773282-before_labeled.png"
    with open(path_to_image, "rb") as f:
        encoded_image = base64.b64encode(f.read())
    encoded_image_text = encoded_image.decode("utf-8")
    base64_qwen = f"data:image;base64,{encoded_image_text}"
