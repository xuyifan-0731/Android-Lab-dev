...
def process_log(file):
    try:
        log_path = os.path.join("/raid/xuyifan/Android-Lab-main/logs/android_world/v26_android_world_250307_text__1history-3e", file)
...
if __name__ == "__main__":
    files = os.listdir("/raid/xuyifan/Android-Lab-main/logs/android_world/v26_android_world_250307_text__1history-3e")
